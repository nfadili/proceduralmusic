...
# Scales #
MAJOR_SCALE = [0, M2, M3, P4, P5, M6, M7, P8]
MINOR_SCALE_NATURAL = [0, WHOLE, HALF, WHOLE, WHOLE, HALF, WHOLE, WHOLE]
MINOR_SCALE_HARMONIC = [0, WHOLE, HALF, WHOLE, WHOLE, HALF, WHOLE_HALF, HALF]
